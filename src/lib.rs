...
pub use axis::{Axis2, Axis3, Axis4};
...
pub mod prelude {
    #[doc(no_inline)]
    pub use super::{
        Angle, AngleConsts as _, AsRaw, Axis2, Axis3, Axis4, Box2, Box3, FloatAngleExt as _,
        FromRaw, Matrix2, Matrix3, Matrix4, Point2, Point3, Point4, Rect, Scalar as _, Size2,
        Size3, Swizzle as _, ToRaw, Unit, Vector2, Vector3, Vector4,
    };
    #[doc(no_inline)]
